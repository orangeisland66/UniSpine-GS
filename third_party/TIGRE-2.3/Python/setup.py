...
def locate_cuda():
    ...
    cuda_lib = pjoin(cuda_home, pjoin("lib", "x64") if IS_WINDOWS else "lib64")
    if not IS_WINDOWS and not os.path.exists(cuda_lib):
        # Conda CUDA packages place libcudart under $CONDA_PREFIX/lib.
        cuda_lib = pjoin(cuda_home, "lib")
